...
Access the web interface at http://localhost with default credentials `Admin`/`zabbix`.

📖 **For detailed instructions, troubleshooting, and examples, see [docs/QUICKSTART.md](docs/QUICKSTART.md)**
