...
![CI](https://github.com/zabbix/zabbix-docker/workflows/CI/badge.svg?branch=3.0&event=release)
![CI](https://github.com/zabbix/zabbix-docker/workflows/CI/badge.svg?branch=3.0&event=push)
