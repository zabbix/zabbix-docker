...
prepare_php_config() {
    ...
    export ZBX_HISTORYPROVIDERS="${ZBX_HISTORYPROVIDERS:-[]}"
    ...
    export ZBX_CERT_STORAGE="${ZBX_CERT_STORAGE:-database}"
    export ZBX_BANNERS_ENABLED="${ZBX_BANNERS_ENABLED:-true}"
    export ZBX_HTTP_AUTH_ENABLED="${ZBX_HTTP_AUTH_ENABLED:-true}"
    export ZBX_MODULES_CONFIG_ENABLED="${ZBX_MODULES_CONFIG_ENABLED:-true}"
    export ZBX_MEDIA_TYPE_DENYLIST="${ZBX_MEDIA_TYPE_DENYLIST:-[]}"
