...
proxy_config() {
    ...
    update_config_var "${ZBX_PROXY_CONFIG}" "MaxConcurrentChecksPerPoller" "${ZBX_MAXCONCURRENTCHECKSPERPOLLER:-}"

    update_config_var "${ZBX_PROXY_CONFIG}" "ProxyBufferMode" "${ZBX_PROXYBUFFERMODE:-}"
    update_config_var "${ZBX_PROXY_CONFIG}" "ProxyMemoryBufferAge" "${ZBX_PROXYMEMORYBUFFERAGE:-}"
    update_config_var "${ZBX_PROXY_CONFIG}" "ProxyMemoryBufferSize" "${ZBX_PROXYMEMORYBUFFERSIZE:-}"
    ...
    update_config_var "${ZBX_PROXY_CONFIG}" "StartAgentPollers" "${ZBX_STARTAGENTPOLLERS:-}"
    ...
    update_config_var "${ZBX_PROXY_CONFIG}" "StartHTTPAgentPollers" "${ZBX_STARTHTTPAGENTPOLLERS:-}"
    ...
    update_config_var "${ZBX_PROXY_CONFIG}" "StartSNMPPollers" "${ZBX_STARTSNMPPOLLERS:-}"
    ...
    update_config_var "${ZBX_PROXY_CONFIG}" "SocketDir" "/tmp/"
