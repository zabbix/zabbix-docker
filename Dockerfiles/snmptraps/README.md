...
These are the only official Zabbix snmptraps Docker images. They are based on Alpine Linux v3.20, Ubuntu 22.04 (jammy), CentOS Stream 9 and Oracle Linux 9 images. The available versions of Zabbix snmptraps are:
