...
These are the only official Zabbix build base (PostgreSQL) Docker images. They are based on Alpine Linux v3.24, Ubuntu 24.04 (noble), CentOS Stream 10 and Oracle Linux 10 images. The available versions of the image are:
