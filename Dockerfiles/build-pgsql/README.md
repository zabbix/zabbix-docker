...
These are the only official Zabbix build base (PostgreSQL) Docker images. They are based on Alpine Linux v3.24, Ubuntu 26.04 (resolute), CentOS Stream 10 and Oracle Linux 10 images. The available versions of the image are:
...
Documentation for this image is stored in the [`build-pgsql/` directory](https://github.com/zabbix/zabbix-docker/tree/trunk/Dockerfiles/build-pgsql) of the [`zabbix/zabbix-docker` GitHub repo](https://github.com/zabbix/zabbix-docker/). Be sure to familiarize yourself with the [repository's `README.md` file](https://github.com/zabbix/zabbix-docker/blob/trunk/README.md) before attempting a pull request.
