...
The Linux images are based on Alpine Linux v3.24, Ubuntu 24.04 (noble), CentOS Stream 10, Oracle Linux 10 and Red Hat Enterprise Linux 9. The available versions of the image are:
...
The image uses the [Zabbix build base](https://github.com/zabbix/zabbix-docker/tree/6.0/Dockerfiles/build-base) image as its prepared build environment and compiles only the components needed by database-independent runtime images.
