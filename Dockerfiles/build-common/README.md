...
The image uses the [Zabbix build base](https://github.com/zabbix/zabbix-docker/tree/trunk/Dockerfiles/build-base) image as its prepared build environment and compiles only the components needed by database-independent runtime images.
