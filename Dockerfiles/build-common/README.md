...
The image uses the [Zabbix build base](https://github.com/zabbix/zabbix-docker/tree/7.4/Dockerfiles/build-base) image as its prepared build environment and compiles only the components needed by database-independent runtime images.
