...
These are the only official Zabbix web interface Docker images. They are based on Alpine Linux v3.24, Ubuntu 24.04 (noble), CentOS Stream 10 and Oracle Linux 10 images. The available versions of Zabbix web interface are:
...
The variable is Zabbix frontend [definition](https://www.zabbix.com/documentation/6.0/en/manual/web_interface/definitions). String used as the name of the Zabbix frontend session cookie. By default, value is `zbx_sessionid`.
