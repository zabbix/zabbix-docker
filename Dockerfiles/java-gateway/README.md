...
These are the only official Zabbix Java Gateway Docker images. They are based on Alpine Linux v3.24, Ubuntu 24.04 (noble), CentOS Stream 10 and Oracle Linux 10 images. The available versions of Zabbix Java Gateway are:
