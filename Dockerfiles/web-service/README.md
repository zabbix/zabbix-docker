...
These are the only official Zabbix web service Docker images. They are based on Alpine Linux v3.20, Ubuntu 24.04 (noble) and Oracle Linux 9 images. The available versions of Zabbix web service are:
