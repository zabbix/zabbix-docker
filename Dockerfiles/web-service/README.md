...
These are the only official Zabbix web service Docker images. They are based on Alpine Linux v3.24, Ubuntu 26.04 (resolute), CentOS Stream 10 and Oracle Linux 10 images. The available versions of Zabbix web service are:
...
Please use official documentation for [``zabbix_web_service.conf``](https://www.zabbix.com/documentation/7.0/en/manual/appendix/config/zabbix_web_service) to get more information about the variables.
